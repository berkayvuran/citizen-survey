...
tav.KURUM_ILI,
COUNT (*) AS 'sayi=25'
FROM v_TUM_ANKET_VERILERI tav
WHERE tav.CallTime > '2020-01-01 00:00:00.000'
and tav.CallTime < '2020-12-31 23:59:59.999'
AND tav.Reason IS NULL
AND tav.soru != 'Soru_yok'
and tav.Puan=25
GROUP BY tav.KURUM_ILI
ORDER BY tav.KURUM_ILI
OPTION (MAXDOP 16)
